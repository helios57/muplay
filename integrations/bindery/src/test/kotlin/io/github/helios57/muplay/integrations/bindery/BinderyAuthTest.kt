package io.github.helios57.muplay.integrations.bindery

import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.FIRST_KEY
import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.SECOND_KEY
import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.client
import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.fixture
import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.json
import io.github.helios57.muplay.integrations.bindery.BinderyTestServer.next
...
class BinderyAuthTest {
  ...
  fun `a base url with a path prefix resolves endpoints underneath it`() = runTest {
    server.enqueue(fixture("bindery/health.json"))
    val prefixed = io.github.helios57.muplay.integrations.IntegrationBaseUrl.parse(
      server.url("/bindery").toString(),
      io.github.helios57.muplay.integrations.CleartextPolicy.Allowed,
    ) as io.github.helios57.muplay.integrations.BaseUrlResult.Valid

    BinderyClient(
      io.github.helios57.muplay.integrations.IntegrationCredentials.Bindery(prefixed.url, FIRST_KEY),
    ).health()
