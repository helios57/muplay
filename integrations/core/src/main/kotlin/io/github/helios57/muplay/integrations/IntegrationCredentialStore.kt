...
import io.github.helios57.muplay.database.KeystoreCipher
import io.github.helios57.muplay.database.KeystoreKeys
 ...
 *
 * The **same mechanism** as `io.github.helios57.muplay.database.CredentialStore`, deliberately and not
...
class IntegrationCredentialStore @Inject constructor(
  ...
  companion object {
    ...
    fun keyAlias(service: IntegrationService): String = when (service) {
      IntegrationService.LIDARR -> "io.github.helios57.muplay.integrations.lidarr"
