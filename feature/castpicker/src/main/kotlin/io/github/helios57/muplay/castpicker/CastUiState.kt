 ...
 *
 * Every field comes from the [io.github.helios57.muplay.cast.discovery.CastDevice] it describes, and
 ...
 * (`io.github.helios57.muplay.model.BookSettings.speed`, stored on the progress row), so the *number* exists. What
...
internal object FailurePhrases {
  /** `io.github.helios57.muplay.cast.control.RendererFollowsAnotherException`'s message. */
