package io.github.helios57.muplay.setup
 ...
 * member.
 *
 * Two of the four mirror the line [io.github.helios57.muplay.network.SubsonicException] itself already draws
...
sealed interface SetupFailureReason {
   ...
   * (e.g. wrong credentials, [io.github.helios57.muplay.network.SubsonicErrorException.code] `40`) or an
   * unsuccessful HTTP status ([io.github.helios57.muplay.network.SubsonicHttpException.status]). [code] carries
   ...
   * unparseable response. Structurally not a [io.github.helios57.muplay.network.SubsonicException] (see that
