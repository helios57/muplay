...
sealed interface SetupUiState {
   ...
   *
   * [canContinue] is false while any library is still [io.github.helios57.muplay.model.LibraryRole.UNASSIGNED]:
...
interface SetupCredentialSink {
  suspend fun save(credentials: io.github.helios57.muplay.model.SubsonicCredentials)
}
...
interface SetupLibrarySink {
  ...
  suspend fun setRole(musicFolderId: Int, role: io.github.helios57.muplay.model.LibraryRole)
