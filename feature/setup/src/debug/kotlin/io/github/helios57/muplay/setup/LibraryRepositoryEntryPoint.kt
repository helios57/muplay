...
/**
 * A minimal, ad-hoc way into the real production Hilt graph for `io.github.helios57.muplay.FirstRunJourneyTest`
 * (`:app`'s instrumented tests), which needs to reset every library back to
 * [io.github.helios57.muplay.model.LibraryRole.UNASSIGNED] between test methods -- the Room database this app
 ...
 * is part of that same compilation**. `app/src/debug/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt`
