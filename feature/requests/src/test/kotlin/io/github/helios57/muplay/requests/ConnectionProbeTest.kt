...
import io.github.helios57.muplay.integrations.bindery.BinderyHttpException
...
class ConnectionProbeTest {
  ...
  private suspend fun observe(credentials: io.github.helios57.muplay.integrations.IntegrationCredentials) =
  ...
  fun `a lidarr that rejects the key is reachable, and carries the refusal`() = runTest {
    ...
    assertThat(
      ConnectionCheck.of(
        io.github.helios57.muplay.integrations.IntegrationService.LIDARR,
