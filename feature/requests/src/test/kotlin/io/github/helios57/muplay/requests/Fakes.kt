package io.github.helios57.muplay.requests

import io.github.helios57.muplay.database.SyncState
import io.github.helios57.muplay.integrations.BaseUrlResult
import io.github.helios57.muplay.integrations.CleartextPolicy
import io.github.helios57.muplay.integrations.IntegrationBaseUrl
import io.github.helios57.muplay.integrations.IntegrationCredentials
import io.github.helios57.muplay.integrations.IntegrationService
import io.github.helios57.muplay.integrations.bindery.BinderyBook
import io.github.helios57.muplay.integrations.bindery.BinderyBookCandidate
import io.github.helios57.muplay.integrations.bindery.BinderyBookPage
import io.github.helios57.muplay.integrations.bindery.BinderyMediaType
import io.github.helios57.muplay.integrations.bindery.BinderyServer
import io.github.helios57.muplay.integrations.bindery.BinderySource
import io.github.helios57.muplay.integrations.bindery.BinderySourceFactory
import io.github.helios57.muplay.integrations.db.MediaRequestDao
import io.github.helios57.muplay.integrations.db.MediaRequestEntity
import io.github.helios57.muplay.integrations.lidarr.LidarrAddOutcome
import io.github.helios57.muplay.integrations.lidarr.LidarrAddTargets
import io.github.helios57.muplay.integrations.lidarr.LidarrAlbumCandidate
import io.github.helios57.muplay.integrations.lidarr.LidarrAlbumProgress
import io.github.helios57.muplay.integrations.lidarr.LidarrProfile
import io.github.helios57.muplay.integrations.lidarr.LidarrQueueItem
import io.github.helios57.muplay.integrations.lidarr.LidarrRootFolder
import io.github.helios57.muplay.integrations.lidarr.LidarrServer
import io.github.helios57.muplay.integrations.lidarr.LidarrSource
import io.github.helios57.muplay.integrations.lidarr.LidarrSourceFactory
import io.github.helios57.muplay.integrations.requests.ConfiguredServices
...
fun quietMirror() = io.github.helios57.muplay.integrations.requests.MirrorSync { SyncState.UpToDate }

fun quietSearch() = io.github.helios57.muplay.integrations.requests.AlbumSearch { _, _, _ ->
  SearchResults(artists = emptyList(), albums = emptyList(), songs = emptyList())
}

fun quietRoles() = io.github.helios57.muplay.integrations.requests.LibraryRoles { emptyList() }
