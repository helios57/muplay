...
import io.github.helios57.muplay.integrations.lidarr.LidarrHttpException
import io.github.helios57.muplay.integrations.requests.RequestArrivalDetector
import io.github.helios57.muplay.integrations.requests.RequestCandidate
import io.github.helios57.muplay.integrations.requests.RequestsRepository
...
class RequestsViewModelTest {
  ...
  fun `a refusal carrying the server's own words reaches the screen`() = runTest(dispatcher) {
    ...
    val failing = object : io.github.helios57.muplay.integrations.bindery.BinderySource by bindery {
      override suspend fun submitBook(
        candidate: io.github.helios57.muplay.integrations.bindery.BinderyBookCandidate,
        mediaType: io.github.helios57.muplay.integrations.bindery.BinderyMediaType,
        searchOnAdd: Boolean,
  ...
  fun `the screen polls once when it opens, and a service that failed is named`() = runTest(dispatcher) {
    ...
    val failing = object : io.github.helios57.muplay.integrations.lidarr.LidarrSource by lidarr {
