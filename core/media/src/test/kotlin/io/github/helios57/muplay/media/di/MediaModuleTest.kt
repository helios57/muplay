...
import io.github.helios57.muplay.cast.route.CastRoute
import io.github.helios57.muplay.media.AudiobookItem
...
import io.github.helios57.muplay.media.BookPlaybackSettings
import io.github.helios57.muplay.cast.route.UnroutableReason
...
class MediaModuleTest {
  ...
  private fun device() = io.github.helios57.muplay.cast.discovery.CastDevice(
    udn = "uuid:test",
