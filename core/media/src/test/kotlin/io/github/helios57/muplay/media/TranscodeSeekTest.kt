...
class TranscodeSeekTest {
  ...
  fun `the two wire values this client can ask for are the two this decision distinguishes`() {
    assertThat(TranscodeSeek.methodFor(io.github.helios57.muplay.model.StreamFormat.Raw.wireValue, true, 5_000L))
      .isEqualTo(SeekMethod.InPlace)
    assertThat(TranscodeSeek.methodFor(io.github.helios57.muplay.model.StreamFormat.Mp3.WIRE_VALUE, true, 5_000L))
      .isEqualTo(SeekMethod.ReissueWithOffset(5))
  }
