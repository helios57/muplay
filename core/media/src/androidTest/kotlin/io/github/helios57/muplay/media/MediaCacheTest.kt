...
import io.github.helios57.muplay.media.di.MediaCacheModule
...
class MediaCacheTest {
   ...
   * under `/data/data/io.github.helios57.muplay/databases/`, which is **outside `cacheDir`** and survives OS
