 ...
 * the answer really does reach a decoder, is `io.github.helios57.muplay.CarResumeJourneyTest`, over IPC, against
...
class BrowsePlaybackTest {
  ...
  private fun queueOf(albumId: String, startIndex: Int) =
    io.github.helios57.muplay.media.PlaybackQueue.of(songsOf(albumId), startIndex)
