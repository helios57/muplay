...
import io.github.helios57.muplay.media.browse.BrowseGraph
import io.github.helios57.muplay.media.browse.MuPlayLibraryCallback
 ...
 * instrumented suite runs inside `io.github.helios57.muplay`'s own process and uid, so every controller it can
 ...
 * `io.github.helios57.muplay.MuPlaybackServiceTest`, every test of which would go red if this gate refused too
 * much.
 *
...
class ControllerAccessGateTest {
  ...
  fun anAppThePlatformDoesNotTrustWithMediaControlIsRefused() {
    ...
    // </queries>, builds a SessionToken for io.github.helios57.muplay/io.github.helios57.muplay.media.MuPlaybackService and
