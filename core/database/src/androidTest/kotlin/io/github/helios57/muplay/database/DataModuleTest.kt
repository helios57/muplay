...
import io.github.helios57.muplay.database.di.DataModule
...
class DataModuleTest {
  ...
  fun theProvidedCredentialDataStoreWritesWhereTheAppExpects() = runTest {
    ...
    CredentialStore(credentialDataStore).save(
      io.github.helios57.muplay.model.SubsonicCredentials("https://music.example", "alice", "sesame"),
    )
  ...
  fun signingOutDoesNotForgetTheSpeakers() = runTest {
    ...
    credentialStore.save(io.github.helios57.muplay.model.SubsonicCredentials("http://nav.example", "u", "p"))
