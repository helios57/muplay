 ...
 *
 * Neither alias here is one the app ships (`io.github.helios57.muplay.credentials`,
 * `io.github.helios57.muplay.integrations.lidarr`, `io.github.helios57.muplay.integrations.bindery`): this class deletes the
...
class KeystoreKeysTest {
  ...
  private val first = "io.github.helios57.muplay.test.first"
  private val second = "io.github.helios57.muplay.test.second"
  ...
  fun deletingAnAliasThatDoesNotExistIsNotAnError() {
    ...
    KeystoreKeys.delete("io.github.helios57.muplay.test.never-created")
    assertThat(KeystoreKeys.exists("io.github.helios57.muplay.test.never-created")).isFalse()
  }
}
