package io.github.helios57.muplay.network.model
 ...
 * the spec (`required: ["id"]`), which [io.github.helios57.muplay.network.SubsonicClient.getMusicFolders] accounts
 ...
 * places no `minItems` constraint on it) — [io.github.helios57.muplay.model.ServerCapabilities] is built to treat
