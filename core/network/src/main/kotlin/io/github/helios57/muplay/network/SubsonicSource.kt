...
interface SubsonicSource {
   ...
   * entries may come from any library. See [io.github.helios57.muplay.model.Playlist].
   */
   ...
   *
   * Plan 1 built the three-tier negotiation and [io.github.helios57.muplay.model.ServerCapabilities]; until this
