package io.github.helios57.muplay.model.browse
...
class BrowseSurfacesTest {
  ...
  fun `the hint key is a namespaced constant, because it goes into someone else's bundle`() {
    ...
    assertThat(BrowseSurfaces.HINT_KEY).isEqualTo("io.github.helios57.muplay.browse.SURFACE")
  ...
  fun `our own package is compared exactly too, so a suffixed applicationId is a different app`() {
    ...
    // `io.github.helios57.muplay.debug` a real, installable, DIFFERENT app. A `startsWith` or an
    // `equalsIgnoreCase` on this side would hand it -- and `io.github.helios57.muplay.evil` with it -- the
    ...
    assertThat(
      listOf(
        BrowseSurfaces.of("io.github.helios57.muplay.debug", OWN, isCarController = false, hintSurface = BrowseSurfaces.HINT_WATCH),
        BrowseSurfaces.of("io.github.helios57.muplay.evil", OWN, isCarController = false, hintSurface = BrowseSurfaces.HINT_CAR),
        BrowseSurfaces.of("io.github.helios57.muplay", "io.github.helios57.muplay.debug", isCarController = false, hintSurface = BrowseSurfaces.HINT_WATCH),
        ...
        BrowseSurfaces.of("io.github.helios57.muplay.debug", "io.github.helios57.muplay.debug", isCarController = false, hintSurface = BrowseSurfaces.HINT_WATCH),
      ),
    ).containsExactly(
      BrowseSurface.PHONE,
      BrowseSurface.PHONE,
  ...
  private companion object {
    const val OWN = "io.github.helios57.muplay"
