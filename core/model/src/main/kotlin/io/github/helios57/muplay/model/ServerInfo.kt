 ...
 * of.
 *
 * Domain-level and deliberately not the raw network DTO: [io.github.helios57.muplay.network.SubsonicClient.ping]
 * only ever returns this once the response has already been proven *not* to be a Subsonic-level
 * failure (see [io.github.helios57.muplay.network.SubsonicException]), so every field here reflects a server that
