 ...
 * `io.github.helios57.muplay.cast.fake.FakeDescriptions`, on purpose: a change to the fake's documents must not
...
class DeviceDescriptionTest {
   ...
   *
   * [io.github.helios57.muplay.cast.net.LocalNetworkOnly] bounds the damage and does not remove it: it refuses
   ...
   * definition [io.github.helios57.muplay.cast.net.LocalNetworkOnly] has, so this rule is the only thing standing
