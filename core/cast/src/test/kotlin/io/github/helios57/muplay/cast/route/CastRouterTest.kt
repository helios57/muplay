package io.github.helios57.muplay.cast.route

import io.github.helios57.muplay.cast.didl.CastItem
import io.github.helios57.muplay.cast.didl.DidlLite
import io.github.helios57.muplay.cast.didl.MimeAgreement
...
import io.github.helios57.muplay.cast.soap.UpnpError
import io.github.helios57.muplay.cast.soap.UpnpErrorException
...
class CastRouterTest {
  ...
  private class ConstantUpstream(private val content: ByteArray) : ProxyUpstream {
    ...
    /** Artwork bytes, so a route that publishes a cover can be fetched as well as minted. */
