package io.github.helios57.muplay.cast.session

import io.github.helios57.muplay.cast.control.UpnpRenderer
import io.github.helios57.muplay.cast.didl.ServedMedia
...
import io.github.helios57.muplay.cast.net.LocalAddress
import io.github.helios57.muplay.cast.proxy.ByteRange
...
import io.github.helios57.muplay.cast.proxy.UpstreamBody
 ...
 * they are given, and [io.github.helios57.muplay.cast.http.CastHttpClient] speaks plain HTTP on the LAN, so a
 ...
 * one: a field added to [io.github.helios57.muplay.cast.didl.DidlLite], a new argument on a new action, or a
 ...
 * [io.github.helios57.muplay.cast.route.CastRoute.RendererDirect]'s `CurrentURI`, which is the Navidrome URL
