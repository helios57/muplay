package io.github.helios57.muplay.cast.fake

import io.github.helios57.muplay.cast.discovery.DeviceDescription
import io.github.helios57.muplay.cast.http.HttpHeaders
import io.github.helios57.muplay.cast.http.HttpWire
import io.github.helios57.muplay.cast.soap.SoapArgument
import io.github.helios57.muplay.cast.soap.SoapEnvelope
...
class RecordedSoap(val headBytes: ByteArray, val bodyBytes: ByteArray) {
   ...
   *
   * Hardened the same way [io.github.helios57.muplay.cast.soap.SoapEnvelope] hardens the response parse -- no
 ...
 * DOCTYPE is refused **in code**, through [io.github.helios57.muplay.cast.soap.SoapEnvelope.declaresDoctype],
