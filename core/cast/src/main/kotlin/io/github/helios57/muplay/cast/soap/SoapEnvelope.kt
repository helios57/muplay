 ...
 * [io.github.helios57.muplay.cast.http.CastHttpClient] would raise for the same bytes one layer down.
 *
...
object SoapEnvelope {
   ...
   * [io.github.helios57.muplay.cast.http.CastHttpClient] returns 5xx rather than throwing: throwing there would
   ...
   * [io.github.helios57.muplay.cast.discovery.DeviceDescription.parse] refuses one and for the reason recorded
