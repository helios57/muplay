package io.github.helios57.muplay.cast.soap
 ...
 * `IllegalArgumentException` [io.github.helios57.muplay.cast.http.CastHttpClient] raises for the same inputs --
 ...
 * [io.github.helios57.muplay.cast.http.HttpWire.headerLine] now refuses CR, LF and NUL outright, so that exact
...
object SoapNames {
  ...
  /**
   * The control URL, checked for exactly what [io.github.helios57.muplay.cast.http.CastHttpClient.exchange] would
   ...
   * [io.github.helios57.muplay.cast.net.LocalNetworkOnly.require], is applied by the client on every request, and
   ...
   * rule, and the same spelling, as [io.github.helios57.muplay.cast.http.HttpWire]'s own.
   *
