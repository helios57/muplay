...
import io.github.helios57.muplay.cast.proxy.PublishedArtwork
import io.github.helios57.muplay.cast.proxy.PublishedMedia
...
sealed interface CastRoute {
  ...
  data class Proxied(
     ...
     * given, and [io.github.helios57.muplay.cast.http.CastHttpClient] speaks plain HTTP. The 128-bit token design
     ...
     * [io.github.helios57.muplay.cast.proxy.MediaProxyServer.awaitRequest], which waits on this route's own
     ...
     * session lasts. [io.github.helios57.muplay.cast.proxy.PublishedMedia] redacts its `path` for this exact
