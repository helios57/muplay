...
data class CastSource(
   ...
   * [io.github.helios57.muplay.cast.route.CastRoute.Proxied.artwork].
   */
 ...
 * it is not the source's: it is whatever [io.github.helios57.muplay.cast.route.CastRouter] decided, which for the
...
object CastItems {
   ...
   *   this phone, from [io.github.helios57.muplay.cast.route.CastRoute.Proxied.artwork]. `null` for an item with
