...
class ConventionTest {
   ...
   *
   * ```
   * import io.github.helios57.muplay.integrations.CleartextPolicy as CP
  ...
  fun `the merged-manifest gate still requires the playback service and its permissions`() {
    ...
    assertThat(
      listOf(
        ...
        "io.github.helios57.muplay.media.MuPlaybackService",
  ...
  private val CONVENTION_TEST_PATH = "app/src/test/kotlin/io/github/helios57/muplay/ConventionTest.kt"
  ...
  fun `a declared play-from-search filter must have a handler and a gate entry`() {
    ...
    val service = File(
      repoRoot(),
      "core/media/src/main/kotlin/io/github/helios57/muplay/media/MuPlaybackService.kt",
    )
   ...
   *   -> ["app/src/androidTest/kotlin/io/github/helios57/muplay/AlbumRouteJourneyTest.kt: NOT_FOUND_LABEL"]
   * ```
   *
  ...
  fun `the cleartext policy and the cleartext manifest cannot disagree`() {
    val root = repoRoot()
    val debugModule = File(root, "app/src/debug/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt")
    val releaseModule = File(root, "app/src/release/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt")
  ...
  fun `nothing a release build compiles names CleartextPolicy Allowed`() {
    val root = repoRoot()
    val debugPolicy =
      File(root, "app/src/debug/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt").canonicalFile
    val urlParser =
      File(root, "integrations/core/src/main/kotlin/io/github/helios57/muplay/integrations/IntegrationBaseUrl.kt")
        .canonicalFile
    ...
    assertThat(scanned.map { it.canonicalFile })
      ...
      .contains(File(root, "app/src/release/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt").canonicalFile)
  ...
  fun `git ignores every shape key material takes`() {
    ...
    val candidates = listOf(
      "keystore.properties",
      "upload-keystore.jks",
      "io/github/helios57/muplay-upload.keystore",
      "ci/release.p12",
      "secrets/upload.pfx",
      "upload.bks",
      "io/github/helios57/muplay.pepk",
    )
