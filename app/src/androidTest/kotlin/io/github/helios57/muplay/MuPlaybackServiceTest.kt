...
import io.github.helios57.muplay.database.CredentialStoreEntryPoint
import io.github.helios57.muplay.media.PlaybackConnection
import io.github.helios57.muplay.media.ArtworkUri
...
import io.github.helios57.muplay.media.MuPlaybackService
import io.github.helios57.muplay.media.PlaybackQueue
import io.github.helios57.muplay.media.PlaybackState
import io.github.helios57.muplay.model.SleepTimerRequest
import io.github.helios57.muplay.model.SleepTimerState
...
class MuPlaybackServiceTest {
  ...
  /**
   * Every field of [io.github.helios57.muplay.media.PlaybackState] that carries information, observed at a value
   ...
   * [io.github.helios57.muplay.media.PlaybackState.NOTHING_PLAYING] carries `MEDIA_TYPE_MIXED`, so a connection
   ...
   * neighbours use, and as `app/src/debug/kotlin/io/github/helios57/muplay/di/CleartextPolicyModule.kt`.
