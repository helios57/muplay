...
import io.github.helios57.muplay.library.OUT_OF_SCOPE_SUFFIX
import io.github.helios57.muplay.model.LibraryRole
import io.github.helios57.muplay.setup.LibraryRepositoryEntryPoint
 ...
 * (`/data/user/0/io.github.helios57.muplay/files/store-screenshots`). `ci/store-screenshots.sh` runs this class
...
class StoreScreenshotsTest {
   ...
   * with [io.github.helios57.muplay.ui.NAV_TAB_TAG_PREFIX] for this, the navigation bar's answer to `MiniPlayer`'s
