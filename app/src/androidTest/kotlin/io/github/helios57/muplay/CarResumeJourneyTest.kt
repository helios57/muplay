...
import io.github.helios57.muplay.database.MediaProgressEntryPoint
 ...
 * `io.github.helios57.muplay.media.BrowseResumeAudioTest` in `:core:media`, which binds a policy that answers one.
 *
